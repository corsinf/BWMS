"""
Django settings for gestion_proyecto_2 project.
...
SECRET_KEY = 'django-insecure-s@4wn@^%bw6j$1d@#ufzshwwd*q&ji3i2%rb0)a@qr-^wm21gk'
...
ROOT_URLCONF = 'gestion_proyecto_2.urls'
...
WSGI_APPLICATION = 'gestion_proyecto_2.wsgi.application'
